...
from .views.views_hr import CompanyEmployeesView, HRFeedbackAnalyticsView, HREventsView, HREventDetailView
...
urlpatterns = [
    ...
    path("hr/events/", HREventsView.as_view(), name="hr-events"),
